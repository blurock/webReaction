/*
 * $Id: FrameListButton1.java,v 1.1 2008/01/25 13:23:54 blurock Exp $
 *
...
public class FrameListButton1 extends JPanel
{
    ...
    public FrameListButton1(String title,ReactList source,TopReactionMenu top,Dimension psize) {
	super();
