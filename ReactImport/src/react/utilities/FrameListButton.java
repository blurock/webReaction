/*
 * $Id: FrameListButton.java,v 1.1 2008/01/25 13:23:54 blurock Exp $
 *
...
public class FrameListButton extends JPanel
{
	...
	objectPanel = new JPanel(); 
        ...
        public void setup(java.lang.String title,ReactList source,
                            TopReactionMenu top,Dimension psize) {
	Top = top;
	Source = source;
	buttonTitle = title;
