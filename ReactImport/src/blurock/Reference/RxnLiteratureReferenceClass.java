 ...
 * @author reaction
 */
public class RxnLiteratureReferenceClass extends DataObjectClass implements Serializable {
     ...
     */
    public RxnLiteratureReferenceClass() {
        propertySupport = new PropertyChangeSupport(this);
        this.Type = "LiteratureReference";
        this.Identification = 1;
        this.Name = "LiteratureReference";
    }
    /**
     ...
     */
    public RxnLiteratureReferenceClass(int id, String type, String descr) {
        super(id,type,descr);
    }
    ...
    public BaseDataObject BaseDataObjectExample() {
        BaseDataObject obj = (BaseDataObject) new RxnDataLiteratureReference();
        obj.Type = this.Type;
        return obj;
    }
    ...
    public DataObjectClass Clone() {
        RxnLiteratureReferenceClass cls =   new RxnLiteratureReferenceClass(Identification,Name,Description);
        cls.CopyClone(this);
        return cls;
    }
