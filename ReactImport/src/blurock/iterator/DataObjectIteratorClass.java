...
public class DataObjectIteratorClass extends DataObjectClass implements Serializable {
     ...
     */
    public DataObjectIteratorClass(int id, String type, String descr) {
        super(id,type,descr);
    }
    ...
    public BaseDataObject BaseDataObjectExample() {
        BaseDataObject obj = (BaseDataObject) new BaseDataObjectIterator();
        obj.Type = this.Type;
        return obj;
    }
    ...
    public DataObjectClass Clone() {
        DataObjectClass cls =   new DataObjectIteratorClass(Identification,Name,Description);
        cls.CopyClone(this);
    ...
    public void CopyClone(DataObjectClass cls) {
        super.CopyClone(cls);
        DataObjectIteratorClass c = (DataObjectIteratorClass) cls;
        ParameterKeys.CopyClone(c.ParameterKeys);
    }
