 ...
 * @author reaction
 */
public class DataSingleConversionSetClass extends DataObjectClass implements Serializable {
    
    private PropertyChangeSupport propertySupport;
    DataConversionFactorsClass ConversionClass;
    /**
     * The Empty constructor (default values for Type, etc.)
     */
    public DataSingleConversionSetClass() {
     ...
     */
    public DataSingleConversionSetClass(int id, String type, String descr) {
        super(id,type,descr);
    }
    ...
    public BaseDataObject BaseDataObjectExample() {
        BaseDataObject obj = (BaseDataObject) new RxnDataSingleConversionSet();
        obj.Type = this.Type;
        return obj;
    }
    ...
    public DataObjectClass Clone() {
        DataObjectClass cls =   new DataSingleConversionSetClass(Identification,Name,Description);
        cls.CopyClone(this);
        return cls;
    }
