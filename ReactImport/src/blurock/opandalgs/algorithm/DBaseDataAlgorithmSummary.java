 ...
 * @author reaction
 */
public class DBaseDataAlgorithmSummary extends DBaseDataObject implements Serializable {
     ...
     */
    public DBaseDataAlgorithmSummary(ObjectDisplayManager man,BaseDataObject obj,DataObjectClass cls) {
        super(man,obj,cls);
    ...
    public JPanel objectAsPanel() {
        BaseDataAlgorithmSummary o = (BaseDataAlgorithmSummary) Object;
        SimpleAlgorithmPanel panel = new SimpleAlgorithmPanel(o);
        return panel;
    }
