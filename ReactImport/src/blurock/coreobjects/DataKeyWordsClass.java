...
public class DataKeyWordsClass extends DataObjectClass implements Serializable {
     ...
     */
    public DataKeyWordsClass(int id, String type, String descr) {
        super(id,type,descr);
    }
    ...
    public BaseDataObject BaseDataObjectExample() {
        BaseDataObject obj = (BaseDataObject) new BaseDataKeyWords();
        obj.Type = this.Type;
        return obj;
    }
    ...
    public DataObjectClass Clone() {
        DataKeyWordsClass cls =   new DataKeyWordsClass(Identification,Name,Description);
        cls.CopyClone(this);
        return cls;
    }
